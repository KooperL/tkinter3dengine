...
def main():
  ...
  objectsGlobal = {
    'ship': object(f'{os.getcwd()}/models/ship.obj', 'ship', (0,0,0),),
    'axis': object(f'{os.getcwd()}/models/axis.obj', 'axis', (0,10,5),),
    'cube': object(f'{os.getcwd()}/models/cube.obj', 'cube', (3,5,0),1),
  }
